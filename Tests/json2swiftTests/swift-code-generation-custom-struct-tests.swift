...
class swift_code_generation_custom_struct_tests: XCTestCase {
    ...
    func test_custom_struct() {
        ...
        let transformation = TransformationFromJSON.toCustomStruct(
            attributeName: "a",
            propertyName: "p",
            type: customStruct
        )
    ...
    func test_array_of_required_struct() {
        ...
        let transformation = TransformationFromJSON.toCustomStructArray(
            attributeName: "a",
            propertyName: "p",
            elementType: someStruct,
            hasOptionalElements: false
        )
        XCTAssertEqual(
            transformation.letStatement,
            "let p = SomeStruct.createRequiredInstances(from: json, arrayKey: \"a\")"
        )
    }
    ...
    func test_array_of_optional_struct() {
        ...
        XCTAssertEqual(
            transformation.letStatement,
            "let p = SomeStruct.createOptionalInstances(from: json, arrayKey: \"a\")"
        )
    }
